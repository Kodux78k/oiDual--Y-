...
<style>
  ...
  .wrap { width: 100%; min-height: 100vh; height: 100%;display: flex; flex-direction: column; }
  iframe#frame { width: 100%; min-height: 100vh;height: 100%; border: 0; border-radius:8px;transition: opacity .3s; }
